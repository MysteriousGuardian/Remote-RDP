...
An external switch lets me configure my network card to act like a switch and route VM traffic to my router. In simpler terms, I create an imaginary switch that connects my VM to my home network. A lot of errors happened during the process, which I will review on a later part. I managed to heal some problems and begin my WireGuard project.
